...
def loadMovieLens2(path='/home/jaydeep/Desktop/Mini_project/movielens_dataset/movielens_1m/chaudhary_devide', file1='/d1.dat', file2='/d10Train.dat'):
    # Load data
    prefs={}
...
if __name__=='__main__':
    st=datetime.now()
    trainPrefs = loadMovieLens2(file1='/d1.dat',file2='/d10Train.dat')
    testPrefs = loadMovieLens(file='/d10Test.dat')
